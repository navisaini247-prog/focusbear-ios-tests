...
xctestCommands.runXCUITest = async function runXCUITest(testRunnerBundleId, appUnderTestBundleId, xctestBundleId, opts = {}) {
    const uiTestProcess = this.createSubProcess(['xctest', 'run', opts.testType || 'ui'], [...(opts.args || []), xctestBundleId, appUnderTestBundleId, testRunnerBundleId], { env: (0, helpers_1.convertToIDBEnv)(opts.env ?? null) ?? undefined });
...
xctestCommands.listXCTestBundles = async function listXCTestBundles() {
    ...
    const bundles = (0, helpers_1.fixOutputToArray)(output);
...
exports.default = xctestCommands;
//# sourceMappingURL=xctest-commands.js.map