...
exports.INSTALLATION_PROXY_SERVICE_NAME = exports.InstallationProxyService = void 0;
...
class InstallationProxyService extends base_service_1.BaseServicePlist {
    ...
    async lookupApplications(opts = {}) {
        ...
        if (opts.bundleIds) {
            request.ClientOptions.BundleIDs = lodash_1.default.isString(opts.bundleIds)
                ? [opts.bundleIds]
                : opts.bundleIds;
        }
        if (opts.applicationType) {
...
exports.default = InstallationProxyService;
