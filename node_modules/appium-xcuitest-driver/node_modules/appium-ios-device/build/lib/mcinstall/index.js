...
exports.MC_INSTALL_SERVICE_NAME = exports.MCInstallProxyService = void 0;
...
class MCInstallProxyService extends base_service_1.BaseServicePlist {
    ...
    async installProfile(path) {
        const payload = await support_1.fs.readFile(path);
    ...
    async removeProfile(ident) {
        ...
        const data = support_1.plist.createBinaryPlist({
...
exports.default = MCInstallProxyService;
