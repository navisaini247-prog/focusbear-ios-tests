...
async function startInstallationProxyService(udid, opts = {}) {
    ...
    return new installation_proxy_1.InstallationProxyService(new plist_service_1.PlistService(socket));
}
...
async function startMCInstallService(udid, opts = {}) {
    ...
    return new mcinstall_1.MCInstallProxyService(new plist_service_1.PlistService(socket));
}
async function startImageMounterService(udid, opts = {}) {
    ...
    return new imagemounter_1.ImageMounter(new plist_service_1.PlistService(socket));
}
