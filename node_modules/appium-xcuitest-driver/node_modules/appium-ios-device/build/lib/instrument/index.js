...
exports.INSTRUMENT_SERVICE_NAME = exports.INSTRUMENT_SERVICE_NAME_VERSION_14 = exports.InstrumentService = exports.INSTRUMENT_CHANNEL = void 0;
const base_service_1 = require("../base-service");
const headers_1 = require("./headers");
const dtx_encode_1 = require("./transformer/dtx-encode");
const dtx_decode_1 = require("./transformer/dtx-decode");
...
exports.INSTRUMENT_CHANNEL = Object.freeze({
 ...
 */
class InstrumentService extends base_service_1.BaseServiceSocket {
    /**
    ...
    constructor(socketClient, event = null) {
        ...
        this._callbacks = new node_events_1.default.EventEmitter();
        this._channelCallbacks = new node_events_1.default.EventEmitter();
        const { proxy, revoke } = defaultDict(() => []);
        this._replyQueues = proxy;
        this._replyQueuesRevoker = revoke;
        this._channels = {};
        this._nextIdentifier = 1;
        this._encoder = new dtx_encode_1.DTXEncoder();
        this._encoder.pipe(this._socketClient);
        this._assignClientFailureHandlers(this._encoder);
        this._decoder = new dtx_decode_1.DTXDecoder();
    ...
    async _callChannel(sync, channelCode, selector, ...auxiliaries) {
        ...
        this._encoder.write({
            ...
            channelCode,
            selector,
            auxiliaries: auxiliaries.length === 1 && auxiliaries[0] instanceof headers_1.DTXMessageAuxBuffer
                ? auxiliaries[0]
                : auxiliaries,
            identifier,
        });
        ...
        if (sync) {
            try {
                return await (0, asyncbox_1.waitForCondition)(() => {
     ...
     */
    _handleData(data) {
        if (lodash_1.default.includes(data.selector, CHANNEL_CANCELED)) {
            this.close();
        }
        if (data.conversationIndex === 1) {
            ...
            if (lodash_1.default.isString(selector) && this._callbacks.listenerCount(selector) > 0) {
     ...
     */
    _replyAck(data) {
        const reply = new headers_1.DTXMessage({
            identifier: data.identifier,
            channelCode: data.channelCode,
            conversationIndex: data.conversationIndex + 1,
            flags: headers_1.FLAG_TYPES.reply,
        });
