...
exports.FLAG_TYPES = exports.DTX_MESSAGE_HEADER_MAGIC_LEN = exports.DTX_MESSAGE_HEADER_MAGIC = exports.DTX_MESSAGE_HEADER_LENGTH = exports.DTX_MESSAGE_PAYLOAD_HEADER_LENGTH = exports.DTXMessage = exports.DTXMessageAux = exports.DTXMessageAuxBuffer = exports.DTXMessagePayloadHeader = exports.DTXMessageHeader = void 0;
        ...
        while (cursor <= length) {
            ...
            switch (type) {
                ...
                case AUX_TYPES.NSKeyed: {
                    ...
                    data.push((0, nskeyed_1.unarchive)(archived_data));
                    cursor += strLen;
                    break;
                }
...
class DTXMessageAuxBuffer {
     ...
     */
    appendObject(value) {
        const buf = (0, nskeyed_1.archive)(value);
...
class DTXMessage {
    ...
    static parse(headerBuf, payloadBuf) {
        ...
        ret.selector = data;
        if (data.length > 0) {
            for (const fun of [nskeyed_1.unarchive, bplist_parser_1.parseBuffer]) {
                try {
