...
const afcencoder_1 = require("./transformer/afcencoder");
const afcdecoder_1 = require("./transformer/afcdecoder");
...
class AfcService extends base_service_1.BaseServiceSocket {
    constructor(socketClient) {
        ...
        this._decoder = new afcdecoder_1.AfcDecoder();
        this._socketClient.pipe(this._splitter).pipe(this._decoder);
        this._encoder = new afcencoder_1.AfcEncoder();
    ...
    async walkDir(dir, recursive, onPath) {
        for (const file of await this.listDirectory(dir)) {
            ...
            const relativePath = node_path_1.default.posix.join(dir, file);
