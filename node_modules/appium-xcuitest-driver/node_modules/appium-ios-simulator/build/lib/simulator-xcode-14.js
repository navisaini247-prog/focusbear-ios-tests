...
exports.SimulatorXcode14 = void 0;
...
class SimulatorXcode14 extends node_events_1.default {
     ...
     */
    async boot() {
        const bootEventsEmitter = new node_events_1.default();
    ...
    async startUIClient(opts = {}) {
        ...
        try {
            ...
            throw new Error(`Got an unexpected error while opening Simulator UI: ` + err.stderr ||
                err.stdout ||
                err.message);
        }
    }
