...
const condition_inducer_client_1 = require("../device/condition-inducer-client");
...
async function listConditionInducers() {
    ...
    const facade = this._conditionInducer ??
        (await (0, condition_inducer_client_1.createConditionInducer)({
...
async function enableConditionInducer(conditionID, profileID) {
    ...
    const facade = await (0, condition_inducer_client_1.createConditionInducer)({
        udid: this.device.udid,
        log: this.log,
        platformVersion: this.opts.platformVersion,
    });
