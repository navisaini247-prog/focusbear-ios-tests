...
async function getExtraTranslateWebCoordsOffset(wvPos, realDims) {
    ...
    const { nativeWebTapTabBarVisibility, nativeWebTapSmartAppBannerVisibility, safariTabBarPosition = support_1.util.compareVersions(this.opts.platformVersion, '>=', '15.0') && isIphone
...
async function mobileCalibrateWebToRealCoordinatesTranslation() {
    ...
    const performCalibrationTap = async (tapX, tapY) => {
        ...
        try {
            ...
            result = lodash_1.default.isPlainObject(title)
                ? title
                : JSON.parse(title);
        }
        catch (e) {
...
async function mobileUpdateSafariPreferences(preferences) {
    const simulator = (0, utils_1.requireSimulator)(this, 'Updating Safari preferences');
