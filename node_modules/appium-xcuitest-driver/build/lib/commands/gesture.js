...
async function mobileShake() {
    await (0, utils_1.requireSimulator)(this, 'Shake device').shake();
}
/**
...
async function mobileScrollToElement(elementId) {
    ...
    return await this.proxyCommand(`/wda/element/${support_1.util.unwrapElement(elementId)}/scrollTo`, 'POST', {});
}
/**
...
async function mobileScroll(name, direction, predicateString, toVisible, distance, elementId) {
    ...
    const endpoint = elementId
        ? `/wda/element/${support_1.util.unwrapElement(elementId)}/scroll`
        : '/wda/scroll';
...
async function mobileDoubleTap(elementId, x, y) {
    const endpoint = elementId
        ? `/wda/element/${support_1.util.unwrapElement(elementId)}/doubleTap`
        : '/wda/doubleTap';
...
async function mobileTwoFingerTap(elementId) {
    const endpoint = elementId
        ? `/wda/element/${support_1.util.unwrapElement(elementId)}/twoFingerTap`
        : '/wda/twoFingerTap';
...
async function mobileTouchAndHold(duration, x, y, elementId) {
    const endpoint = elementId
        ? `/wda/element/${support_1.util.unwrapElement(elementId)}/touchAndHold`
        : '/wda/touchAndHold';
    await this.proxyCommand(endpoint, 'POST', {
...
async function mobileDragFromToWithVelocity(pressDuration, holdDuration, velocity, fromElementId, toElementId, fromX, fromY, toX, toY) {
    ...
    if (fromX === undefined || fromY === undefined || toX === undefined || toY === undefined) {
        throw new driver_1.errors.InvalidArgumentError('When fromElementId is not provided, fromX, fromY, toX, and toY must all be provided');
    }
...
async function mobileForcePress(x, y, duration, pressure, elementId) {
    const endpoint = elementId
        ? `/wda/element/${support_1.util.unwrapElement(elementId)}/forceTouch`
        : `/wda/forceTouch`;
...
async function mobileRotateElement(rotation, velocity, elementId) {
    ...
    const endpoint = elementId
        ? `/wda/element/${support_1.util.unwrapElement(elementId)}/rotate`
        : '/wda/rotate';
    await this.proxyCommand(endpoint, 'POST', params);
}
/**
...
function assertNoWebElements(actionSeq) {
    const isOriginWebElement = (gesture) => lodash_1.default.isPlainObject(gesture) &&
        'origin' in gesture &&
