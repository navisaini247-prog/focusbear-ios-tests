...
class OptionalTunnelAvailabilityCheck {
    ...
    static TUNNEL_CREATION_COMMAND = 'appium driver run xcuitest tunnel-creation';
    async diagnose() {
    ...
    _evaluateTunnelScriptOutput(combinedOutput, exitCode) {
        ...
        return support_1.doctor.okOptional(`Successfully ran '${OptionalTunnelAvailabilityCheck.TUNNEL_CREATION_COMMAND}' without sudo. ` +
